...
class Glitchless():
    def set_rules(self, world, player: int, coins: bool):
        ...
        connect_regions(world, player, AERoom.W1L1Main.value, AERoom.W1L1TrayC.value, lambda state: HasFlyer(state, player))
        ...
        connect_regions(world, player, AERoom.W1L2Main.value, AERoom.W1L2Grunt.value, lambda state: CanSwim(state, player) or HasFlyer(state, player))
        ...
        connect_regions(world, player, AERoom.W2L2Outside.value, AERoom.W2L2Mooshy.value, lambda state: HasHoop(state, player))
        connect_regions(world, player, AERoom.W2L2Fan.value, AERoom.W2L2Nuzzy.value, lambda state: HasSling(state, player) or HasHoop(state, player) or HasPunch(state, player))
        ...
        connect_regions(world, player, AERoom.W2L2Obelisk.value, AERoom.W2L2Bernt.value, lambda state: HasSling(state, player))
        connect_regions(world, player, AERoom.W2L2Water.value, AERoom.W2L2Runt.value, lambda state: CanSwim(state, player) and (HasSling(state, player) or HasHoop(state, player)) and (CanHitOnce(state, player) or HasFlyer(state, player)))
        connect_regions(world, player, AERoom.W2L2Water.value, AERoom.W2L2Hoolah.value, lambda state: CanHitMultiple(state, player))
        connect_regions(world, player, AERoom.W2L2Water.value, AERoom.W2L2Chino.value, lambda state: CanSwim(state, player) and (HasSling(state, player) or HasHoop(state, player)) and (CanHitOnce(state, player) or HasFlyer(state, player)))
        ...
        connect_regions(world, player, AERoom.W4L1SecondRoom.value, AERoom.W4L1Puka.value, lambda state: CanHitMultiple(state, player) or HasFlyer(state, player))
        connect_regions(world, player, AERoom.W4L1SecondRoom.value, AERoom.W4L1MaxMahalo.value, lambda state: HasSling(state, player) and HasFlyer(state, player))
        ...
        connect_regions(world, player, AERoom.W4L2FirstRoom.value, AERoom.W4L2Oreo.value, lambda state: (HasHoop(state, player) and CanHitMultiple(state, player) and CanSwim(state, player)) or HasMobility(state, player))
        connect_regions(world, player, AERoom.W4L2FirstRoom.value, AERoom.W4L2Puddles.value, lambda state: CanDive(state, player))
        connect_regions(world, player, AERoom.W4L2FirstRoom.value, AERoom.W4L2Kalama.value, lambda state: (HasHoop(state, player) and CanHitMultiple(state, player) and CanSwim(state, player)) or HasMobility(state, player))
        ...
        connect_regions(world, player, AERoom.W4L3Stomach.value, AERoom.W4L3Mars.value, lambda state: CanHitOnce(state, player) and HasRC(state, player))
        ...
        connect_regions(world, player, AERoom.W5L1Main.value, AERoom.W5L1Rickets.value, lambda state: HasSling(state, player))
        connect_regions(world, player, AERoom.W5L1Main.value, AERoom.W5L1Skeens.value, lambda state: CanHitMultiple(state, player) or HasFlyer(state, player))
        connect_regions(world, player, AERoom.W5L1Main.value, AERoom.W5L1Chilly.value, lambda state: CanHitMultiple(state, player) or HasFlyer(state, player))
        connect_regions(world, player, AERoom.W5L1Main.value, AERoom.W5L1Denggoy.value, lambda state: CanHitMultiple(state, player) or HasFlyer(state, player))
        ...
        connect_regions(world, player, AERoom.W5L2Entry.value, AERoom.W5L2Storm.value, lambda state: HasFlyer(state, player))
        connect_regions(world, player, AERoom.W5L2Entry.value, AERoom.W5L2Qube.value, lambda state: HasFlyer(state, player))
        connect_regions(world, player, AERoom.W5L2Water.value, AERoom.W5L2Ranix.value, lambda state: HasFlyer(state, player) and HasSling(state, player))
        connect_regions(world, player, AERoom.W5L2Water.value, AERoom.W5L2Sharpe.value, lambda state: HasFlyer(state, player))
        connect_regions(world, player, AERoom.W5L2Water.value, AERoom.W5L2Sticky.value, lambda state: HasFlyer(state, player))
        connect_regions(world, player, AERoom.W5L2Water.value, AERoom.W5L2Droog.value, lambda state: HasFlyer(state, player) and CanDive(state, player))
        connect_regions(world, player, AERoom.W5L2Caverns.value, AERoom.W5L2Gash.value, lambda state: HasFlyer(state, player))
        connect_regions(world, player, AERoom.W5L2Caverns.value, AERoom.W5L2Kundra.value, lambda state: HasFlyer(state, player))
        connect_regions(world, player, AERoom.W5L2Caverns.value, AERoom.W5L2Shadow.value, lambda state: HasFlyer(state, player))
        ...
        connect_regions(world, player, AERoom.W5L3Cave.value, AERoom.W5L3Roti.value, lambda state: CanHitMultiple(state, player))
        connect_regions(world, player, AERoom.W5L3Cave.value, AERoom.W5L3Dissa.value, lambda state: CanHitMultiple(state, player))
        ...
        connect_regions(world, player, AERoom.W7L1Outside.value, AERoom.W7L1Wog.value, lambda state: HasSling(state, player))
        ...
        connect_regions(world, player, AERoom.W7L1Well.value, AERoom.W7L1Voti.value, lambda state: HasSling(state, player))
        ...
        connect_regions(world, player, AERoom.W8L1Outside.value, AERoom.W8L1Kaine.value, lambda state: RCMonkey(state, player))
        connect_regions(world, player, AERoom.W8L1Outside.value, AERoom.W8L1Jaxx.value, lambda state: NoRequirement())
        connect_regions(world, player, AERoom.W8L1Outside.value, AERoom.W8L1Gehry.value, lambda state: CP_FrontBarrels(state, player) and CanDive(state, player) and HasFlyer(state, player))
        connect_regions(world, player, AERoom.W8L1Outside.value, AERoom.W8L1Alcatraz.value, lambda state: NoRequirement())
        connect_regions(world, player, AERoom.W8L1Sewers.value, AERoom.W8L1Tino.value, lambda state: CP_FrontSewer(state, player) and HasRC(state, player))
        connect_regions(world, player, AERoom.W8L1Sewers.value, AERoom.W8L1QBee.value, lambda state: CP_FrontSewer(state, player) and HasRC(state, player))
        connect_regions(world, player, AERoom.W8L1Sewers.value, AERoom.W8L1McManic.value, lambda state: CP_FrontSewer(state, player) and HasRC(state, player))
        connect_regions(world, player, AERoom.W8L1Barrel.value, AERoom.W8L1Dywan.value, lambda state: CP_FrontBarrels(state, player))
        connect_regions(world, player, AERoom.W8L1Barrel.value, AERoom.W8L1CKHutch.value, lambda state: CP_FrontBarrels(state, player) and HasFlyer(state, player) and CanDive(state, player))
        connect_regions(world, player, AERoom.W8L1Barrel.value, AERoom.W8L1Winky.value, lambda state: CP_FrontBarrels(state, player) and HasFlyer(state, player))
        connect_regions(world, player, AERoom.W8L1Barrel.value, AERoom.W8L1BLuv.value, lambda state: CP_FrontBarrels(state, player) and HasFlyer(state, player))
        connect_regions(world, player, AERoom.W8L1Barrel.value, AERoom.W8L1Camper.value, lambda state: CP_FrontBarrels(state, player) and CanDive(state, player) and HasFlyer(state, player))
        connect_regions(world, player, AERoom.W8L1Barrel.value, AERoom.W8L1Huener.value, lambda state: CP_FrontBarrels(state, player) and CanSwim(state, player) and HasFlyer(state, player))
        ...
        connect_regions(world, player, AERoom.W8L3Water.value, AERoom.W8L3Charlee.value, lambda state: TVT_HitButton(state, player) and HasSling(state, player))
        ...
        connect_regions(world, player, AERoom.W9L1Western.value, AERoom.W9L1Shaw.value, lambda state: HasSling(state, player))
        connect_regions(world, player, AERoom.W9L1Western.value, AERoom.W9L1Flea.value, lambda state: HasSling(state, player))
        ...
        connect_regions(world, player, AERoom.W9L1Castle.value, AERoom.W9L1Gordo.value, lambda state: MM_UFODoor(state, player) and HasRC(state, player))
        ...
        if coins:
            ...
            # 4-1
            connect_regions(world, player, AERoom.W4L1SecondRoom.value, AERoom.Coin21.value, lambda state: NoRequirement())
            ...
            connect_regions(world, player, AERoom.W4L3Slide.value, AERoom.Coin28.value,
                            lambda state: (CanSwim(state, player)) and (((CanHitOnce(state, player))) or (HasPunch(state, player))))
            ...
            connect_regions(world, player, AERoom.W8L1Outside.value, AERoom.Coin53.value,
                            lambda state: CP_FrontBarrels(state, player) and CanDive(state, player) and HasFlyer(state, player))
...
def MM_DoubleDoor(state, player):
    return MM_UFODoor(state, player) and HasHoop(state, player) and HasRC(state, player) and CanHitMultiple(state, player)
