...
def set_rules(world, player: int):
    ...
    connect_regions(world, player, AERoom.W2L1Fish.value, AERoom.W2L1Maki.value, lambda state: TJ_FishEntry(state, player) and HasSling(state, player))
    ...
    connect_regions(world, player, AERoom.W2L3Main.value, AERoom.W2L3Spanky.value, lambda state: CR_Inside(state, player) and ((CanSwim(state, player) and CanHitMultiple(state, player)) or HasFlyer(state, player)))
    ...
    connect_regions(world, player, AERoom.W4L1SecondRoom.value, AERoom.W4L1MaxMahalo.value, lambda state: HasHoop(state, player) or (HasSling(state, player) and HasFlyer(state, player)))
    connect_regions(world, player, AERoom.W4L1SecondRoom.value, AERoom.W4L1Moko.value, lambda state: HasFlyer(state, player))
    ...
    connect_regions(world, player, AERoom.W4L2FirstRoom.value, AERoom.W4L2Puddles.value, lambda state: CanDive(state, player) or (HasHoop(state, player) and HasFlyer(state, player)))
    ...
    connect_regions(world, player, AERoom.W4L3Stomach.value, AERoom.W4L3Horke.value, lambda state: CanHitOnce(state, player) and (CanSwim(state, player) or HasFlyer(state, player)))
    connect_regions(world, player, AERoom.W4L3Gallery.value, AERoom.W4L3Howeerd.value, lambda state: DI_SecondHalf(state, player) and HasSling(state, player))
    connect_regions(world, player, AERoom.W4L3Gallery.value, AERoom.W4L3Robbin.value, lambda state: DI_SecondHalf(state, player) and HasSling(state, player))
    ...
    connect_regions(world, player, AERoom.W5L2Water.value, AERoom.W5L2Ranix.value, lambda state: CanSwim(state, player) or HasSling(state, player))
    ...
    connect_regions(world, player, AERoom.W5L2Water.value, AERoom.W5L2Droog.value, lambda state: CanDive(state, player) or HasFlyer(state, player))
    ...
    connect_regions(world, player, AERoom.W5L3Outside.value, AERoom.W5L3Yoky.value, lambda state: HasFlyer(state, player))
    connect_regions(world, player, AERoom.W5L3Outside.value, AERoom.W5L3Jory.value, lambda state: HasFlyer(state, player))
    connect_regions(world, player, AERoom.W5L3Spring.value, AERoom.W5L3Crank.value, lambda state: HasFlyer(state, player))
    connect_regions(world, player, AERoom.W5L3Spring.value, AERoom.W5L3Claxter.value, lambda state: HasFlyer(state, player))
    connect_regions(world, player, AERoom.W5L3Spring.value, AERoom.W5L3Looza.value, lambda state: HasFlyer(state, player))
    ...
    connect_regions(world, player, AERoom.W8L1Outside.value, AERoom.W8L1Gehry.value, lambda state: (CP_FrontBarrels(state, player) and CanDive(state, player)) or HasFlyer(state, player))
    ...
    connect_regions(world, player, AERoom.W8L1Sewers.value, AERoom.W8L1McManic.value, lambda state: ((CP_FrontSewer(state, player) or CP_BackSewer(state, player)) and HasRC(state, player)) or HasFlyer(state, player))
    ...
    connect_regions(world, player, AERoom.W8L1Barrel.value, AERoom.W8L1BLuv.value, lambda state: (CP_FrontBarrels(state, player) and (CanSwim(state, player) or HasFlyer(state, player))) or CP_BackSewer(state, player))
    connect_regions(world, player, AERoom.W8L1Barrel.value, AERoom.W8L1Camper.value, lambda state: (CP_FrontBarrels(state, player) or CP_BackSewer(state, player)) and CanDive(state, player))
    connect_regions(world, player, AERoom.W8L1Barrel.value, AERoom.W8L1Huener.value, lambda state: (CP_FrontBarrels(state, player) and (HasHoop(state, player) or CanSwim(state, player)) and HasFlyer(state, player)) or CP_BackSewer(state, player))
    ...
    connect_regions(world, player, AERoom.W8L2RC.value, AERoom.W8L2Urkel.value, lambda state: SF_CarRoom(state, player) or HasSling(state, player))
    ...
    connect_regions(world, player, AERoom.W8L3Lobby.value, AERoom.W8L3Manic.value, lambda state: HasFlyer(state, player))
    ...
    connect_regions(world, player, AERoom.W9L1Side.value, AERoom.W9L1BG.value, lambda state: MM_SHA(state, player) and HasFlyer(state, player))
...
def CC_WaterRoom(state, player):
    return CanHitMultiple(state, player) or (CanDive(state, player) and (HasFlyer(state, player) or HasPunch(state, player)))
...
def SF_MechRoom(state, player):
    return (HasHoop(state, player) and HasFlyer(state, player)) or (HasClub(state, player) and (HasSling(state, player) or HasRC(state, player))) or HasPunch(state, player)
