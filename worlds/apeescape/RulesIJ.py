...
class IJ():
    def set_rules(self, world, player: int, coins: bool):
        ...
        connect_regions(world, player, AERoom.W1L3Entry.value, AERoom.W1L3Triceratops.value, lambda state: HasSling(state, player))
        ...
        connect_regions(world, player, AERoom.W1L3Entry.value, AERoom.W1L3JThomas.value, lambda state: CanHitOnce(state, player))
        ...
        connect_regions(world, player, AERoom.W1L3Triceratops.value, AERoom.W1L3Rocky.value, lambda state: HasSling(state, player))
        ...
        connect_regions(world, player, AERoom.W2L1Entry.value, AERoom.W2L1Livinston.value, lambda state: CanHitOnce(state, player))
        ...
        connect_regions(world, player, AERoom.W2L1Boulder.value, AERoom.W2L1Elehcim.value, lambda state: (TJ_UFOEntry(state, player) or (TJ_FishEntry(state, player)) and CanHitMultiple(state, player)))
        connect_regions(world, player, AERoom.W2L1Boulder.value, AERoom.W2L1Selur.value, lambda state: ((TJ_UFOEntry(state, player) and TJ_UFOCliff(state, player)) or (TJ_FishEntry(state, player)) and CanHitMultiple(state, player)) and (HasClub(state, player) or HasSling(state, player) or HasFlyer(state, player)))
        ...
        connect_regions(world, player, AERoom.W2L2Outside.value, AERoom.W2L2Kyle.value, lambda state: CanHitOnce(state, player))
        ...
        connect_regions(world, player, AERoom.W2L2Obelisk.value, AERoom.W2L2Bernt.value, lambda state: HasSling(state, player) or HasPunch(state, player))
        connect_regions(world, player, AERoom.W2L2Water.value, AERoom.W2L2Runt.value, lambda state: (CanSwim(state, player) and CanHitOnce(state, player)) or HasSling(state, player) or HasHoop(state, player))
        connect_regions(world, player, AERoom.W2L2Water.value, AERoom.W2L2Hoolah.value, lambda state: CanHitMultiple(state, player))
        connect_regions(world, player, AERoom.W2L2Water.value, AERoom.W2L2Chino.value, lambda state: (CanSwim(state, player) and CanHitOnce(state, player)) or HasSling(state, player) or HasHoop(state, player))
        ...
        connect_regions(world, player, AERoom.W2L3Side.value, AERoom.W2L3Troopa.value, lambda state: (HasSling(state, player) or HasHoop(state, player) or HasFlyer(state, player)))
        connect_regions(world, player, AERoom.W2L3Main.value, AERoom.W2L3Stymie.value, lambda state: CR_Inside(state, player))
        connect_regions(world, player, AERoom.W2L3Main.value, AERoom.W2L3Spanky.value, lambda state: CR_Inside(state, player) and ((CanSwim(state, player) and CanHitMultiple(state, player)) or HasSling(state, player) or HasFlyer(state, player)))
        ...
        connect_regions(world, player, AERoom.W4L1SecondRoom.value, AERoom.W4L1Puka.value, lambda state: CanHitMultiple(state, player) or HasHoop(state, player) or HasFlyer(state, player))
        connect_regions(world, player, AERoom.W4L1SecondRoom.value, AERoom.W4L1MaxMahalo.value, lambda state: HasHoop(state, player) or HasSling(state, player))
        connect_regions(world, player, AERoom.W4L1SecondRoom.value, AERoom.W4L1Moko.value, lambda state: HasSling(state, player) or HasFlyer(state, player))
        ...
        connect_regions(world, player, AERoom.W4L2FirstRoom.value, AERoom.W4L2Chip.value, lambda state: CanSwim(state, player))
        connect_regions(world, player, AERoom.W4L2FirstRoom.value, AERoom.W4L2Oreo.value, lambda state: (HasMobility(state, player)))
        connect_regions(world, player, AERoom.W4L2FirstRoom.value, AERoom.W4L2Puddles.value, lambda state: CanDive(state, player) or HasSling(state, player) or (HasHoop(state, player) and HasFlyer(state, player)))
        connect_regions(world, player, AERoom.W4L2FirstRoom.value, AERoom.W4L2Kalama.value, lambda state: (HasMobility(state, player)))
        connect_regions(world, player, AERoom.W4L2SecondRoom.value, AERoom.W4L2Iz.value, lambda state: CanSwim(state, player) or HasSling(state, player))
        connect_regions(world, player, AERoom.W4L2SecondRoom.value, AERoom.W4L2BongBong.value, lambda state: CanSwim(state, player) or HasSling(state, player))
        connect_regions(world, player, AERoom.W4L2SecondRoom.value, AERoom.W4L2Jux.value, lambda state: CanSwim(state, player) or HasSling(state, player))
        connect_regions(world, player, AERoom.W4L2SecondRoom.value, AERoom.W4L2Pickles.value, lambda state: (CanSwim(state, player) and CanHitMultiple(state, player)) or HasSling(state, player))
        ...
        connect_regions(world, player, AERoom.W4L3Stomach.value, AERoom.W4L3Mars.value, lambda state: HasRC(state, player))
        connect_regions(world, player, AERoom.W4L3Stomach.value, AERoom.W4L3Murky.value, lambda state: CanHitOnce(state, player))
        connect_regions(world, player, AERoom.W4L3Stomach.value, AERoom.W4L3Horke.value, lambda state: CanHitOnce(state, player) and (CanSwim(state, player) or HasSling(state, player) or HasFlyer(state, player)))
        connect_regions(world, player, AERoom.W4L3Gallery.value, AERoom.W4L3Howeerd.value, lambda state: DI_SecondHalf(state, player) and (HasSling(state, player) or HasFlyer(state, player)))
        connect_regions(world, player, AERoom.W4L3Gallery.value, AERoom.W4L3Robbin.value, lambda state: DI_SecondHalf(state, player) and (HasSling(state, player) or HasFlyer(state, player)))
        ...
        connect_regions(world, player, AERoom.W5L1Main.value, AERoom.W5L1Iced.value, lambda state: CanHitOnce(state, player))
        connect_regions(world, player, AERoom.W5L1Main.value, AERoom.W5L1Rickets.value, lambda state: HasSling(state, player) or HasPunch(state, player) or (HasClub(state, player) and HasFlyer(state, player)))
        ...
        connect_regions(world, player, AERoom.W5L2Water.value, AERoom.W5L2Ranix.value, lambda state: CanSwim(state, player) or HasSling(state, player) or (HasHoop(state, player) and HasFlyer(state, player)))
        ...
        connect_regions(world, player, AERoom.W5L2Water.value, AERoom.W5L2Droog.value, lambda state: CanDive(state, player) or HasFlyer(state, player) or HasSling(state, player))
        ...
        connect_regions(world, player, AERoom.W5L3Outside.value, AERoom.W5L3Ameego.value, lambda state: CanDive(state, player))
        connect_regions(world, player, AERoom.W5L3Outside.value, AERoom.W5L3Yoky.value, lambda state: HasSling(state, player) or HasFlyer(state, player))
        connect_regions(world, player, AERoom.W5L3Outside.value, AERoom.W5L3Jory.value, lambda state: HasSling(state, player) or HasFlyer(state, player))
        connect_regions(world, player, AERoom.W5L3Spring.value, AERoom.W5L3Crank.value, lambda state: HasSling(state, player) or HasFlyer(state, player))
        connect_regions(world, player, AERoom.W5L3Spring.value, AERoom.W5L3Claxter.value, lambda state: HasSling(state, player) or HasFlyer(state, player))
        connect_regions(world, player, AERoom.W5L3Spring.value, AERoom.W5L3Looza.value, lambda state: HasSling(state, player) or HasFlyer(state, player))
        connect_regions(world, player, AERoom.W5L3Cave.value, AERoom.W5L3Roti.value, lambda state: CanHitOnce(state, player))
        connect_regions(world, player, AERoom.W5L3Cave.value, AERoom.W5L3Dissa.value, lambda state: CanHitOnce(state, player))
        ...
        connect_regions(world, player, AERoom.W7L1Outside.value, AERoom.W7L1Maralea.value, lambda state: NoRequirement())
        connect_regions(world, player, AERoom.W7L1Outside.value, AERoom.W7L1Wog.value, lambda state: HasClub(state, player) or HasSling(state, player) or HasFlyer(state, player))
        ...
        connect_regions(world, player, AERoom.W7L1Temple.value, AERoom.W7L1Elly.value, lambda state: HasSling(state, player) or HasFlyer(state, player))
        connect_regions(world, player, AERoom.W7L1Temple.value, AERoom.W7L1Chunky.value, lambda state: HasSling(state, player) or HasFlyer(state, player))
        ...
        connect_regions(world, player, AERoom.W7L2Barrel.value, AERoom.W7L2Kong.value, lambda state: WSW_ThirdRoom(state, player) and WSW_FourthRoom(state, player) and (HasSling(state, player) or HasHoop(state, player)))
        connect_regions(world, player, AERoom.W7L2Barrel.value, AERoom.W7L2Phool.value, lambda state: WSW_ThirdRoom(state, player) and WSW_FourthRoom(state, player) and (HasSling(state, player) or HasHoop(state, player) or HasFlyer(state, player)))
        ...
        connect_regions(world, player, AERoom.W7L3Outside.value, AERoom.W7L3Neeners.value, lambda state: CC_5Monkeys(state, player))
        connect_regions(world, player, AERoom.W7L3Outside.value, AERoom.W7L3Charles.value, lambda state: HasPunch(state, player))
        connect_regions(world, player, AERoom.W7L3Castle.value, AERoom.W7L3Gustav.value, lambda state: CC_5Monkeys(state, player))
        connect_regions(world, player, AERoom.W7L3Castle.value, AERoom.W7L3Wilhelm.value, lambda state: CC_5Monkeys(state, player))
        connect_regions(world, player, AERoom.W7L3Castle.value, AERoom.W7L3Emmanuel.value, lambda state: CC_5Monkeys(state, player))
        ...
        connect_regions(world, player, AERoom.W7L3Basement.value, AERoom.W7L3Deveneom.value, lambda state: CC_WaterRoom(state, player))
        ...
        connect_regions(world, player, AERoom.W7L3Elevator.value, AERoom.W7L3Densil.value, lambda state: CC_5Monkeys(state, player))
        ...
        connect_regions(world, player, AERoom.W8L1Outside.value, AERoom.W8L1Gehry.value, lambda state: (CP_FrontBarrels(state, player) and CanDive(state, player)) or HasSling(state, player) or HasFlyer(state, player))
        connect_regions(world, player, AERoom.W8L1Outside.value, AERoom.W8L1Alcatraz.value, lambda state: NoRequirement())
        connect_regions(world, player, AERoom.W8L1Sewers.value, AERoom.W8L1Tino.value, lambda state: (CP_FrontSewer(state, player) or CP_BackSewer(state, player)) and HasRC(state, player))
        connect_regions(world, player, AERoom.W8L1Sewers.value, AERoom.W8L1QBee.value, lambda state: (CP_FrontSewer(state, player) and HasRC(state, player)) or CP_BackSewer(state, player))
        connect_regions(world, player, AERoom.W8L1Sewers.value, AERoom.W8L1McManic.value, lambda state: ((CP_FrontSewer(state, player) or CP_BackSewer(state, player)) and HasRC(state, player)) or HasSling(state, player) or HasFlyer(state, player))
        connect_regions(world, player, AERoom.W8L1Barrel.value, AERoom.W8L1Dywan.value, lambda state: CP_FrontBarrels(state, player) or CP_BackSewer(state, player))
        connect_regions(world, player, AERoom.W8L1Barrel.value, AERoom.W8L1CKHutch.value, lambda state: (CP_FrontBarrels(state, player) or CP_BackSewer(state, player)) and CanDive(state, player))
        connect_regions(world, player, AERoom.W8L1Barrel.value, AERoom.W8L1Winky.value, lambda state: CP_FrontBarrels(state, player) or CP_BackSewer(state, player))
        connect_regions(world, player, AERoom.W8L1Barrel.value, AERoom.W8L1BLuv.value, lambda state: (CP_FrontBarrels(state, player) and (CanSwim(state, player) or HasSling(state, player) or HasFlyer(state, player))) or CP_BackSewer(state, player))
        connect_regions(world, player, AERoom.W8L1Barrel.value, AERoom.W8L1Camper.value, lambda state: ((CP_FrontBarrels(state, player) or CP_BackSewer(state, player)) and CanDive(state, player)) or (HasSling(state, player) and HasRC(state, player)))
        connect_regions(world, player, AERoom.W8L1Barrel.value, AERoom.W8L1Huener.value, lambda state: (CP_FrontBarrels(state, player) and (HasHoop(state, player) or CanSwim(state, player)) and HasFlyer(state, player)) or CP_BackSewer(state, player) or HasSling(state, player))
        ...
        connect_regions(world, player, AERoom.W8L2Outside.value, AERoom.W8L2BigShow.value, lambda state: NoRequirement())
        connect_regions(world, player, AERoom.W8L2Outside.value, AERoom.W8L2Dreos.value, lambda state: NoRequirement())
        connect_regions(world, player, AERoom.W8L2Factory.value, AERoom.W8L2Reznor.value, lambda state: SF_MechRoom(state, player))
        ...
        connect_regions(world, player, AERoom.W8L3Outside.value, AERoom.W8L3Fredo.value, lambda state: HasPunch(state, player))
        connect_regions(world, player, AERoom.W8L3Water.value, AERoom.W8L3Charlee.value, lambda state: TVT_HitButton(state, player))
        connect_regions(world, player, AERoom.W8L3Water.value, AERoom.W8L3Mach3.value, lambda state: TVT_HitButton(state, player))
        connect_regions(world, player, AERoom.W8L3Lobby.value, AERoom.W8L3Tortuss.value, lambda state: NoRequirement())
        connect_regions(world, player, AERoom.W8L3Lobby.value, AERoom.W8L3Manic.value, lambda state: HasSling(state, player) or HasFlyer(state, player))
        connect_regions(world, player, AERoom.W8L3Tank.value, AERoom.W8L3Ruptdis.value, lambda state: TVT_TankRoom(state, player))
        connect_regions(world, player, AERoom.W8L3Tank.value, AERoom.W8L3Eighty7.value, lambda state: TVT_TankRoom(state, player))
        connect_regions(world, player, AERoom.W8L3Tank.value, AERoom.W8L3Danio.value, lambda state: TVT_TankRoom(state, player))
        connect_regions(world, player, AERoom.W8L3Fan.value, AERoom.W8L3Roosta.value, lambda state: TVT_TankRoom(state, player))
        connect_regions(world, player, AERoom.W8L3Fan.value, AERoom.W8L3Tellis.value, lambda state: TVT_TankRoom(state, player))
        connect_regions(world, player, AERoom.W8L3Fan.value, AERoom.W8L3Whack.value, lambda state: TVT_TankRoom(state, player))
        connect_regions(world, player, AERoom.W8L3Fan.value, AERoom.W8L3Frostee.value, lambda state: TVT_TankRoom(state, player))
        ...
        connect_regions(world, player, AERoom.W9L1Coffin.value, AERoom.W9L1Natalie.value, lambda state: MM_Natalie(state, player))
        connect_regions(world, player, AERoom.W9L1Entry.value, AERoom.W9L1Professor.value, lambda state: MM_Professor(state, player))
        connect_regions(world, player, AERoom.W9L1Entry.value, AERoom.W9L1Jake.value, lambda state: MM_Jake(state, player))
        ...
        connect_regions(world, player, AERoom.W9L1Castle.value, AERoom.W9L1Boss.value, lambda state: MM_FinalBoss(state, player))
        ...
        connect_regions(world, player, AERoom.W9L1Western.value, AERoom.W9L1Nak.value, lambda state: HasSling(state, player) or HasHoop(state, player))
        connect_regions(world, player, AERoom.W9L1Western.value, AERoom.W9L1Cloy.value, lambda state: NoRequirement())
        connect_regions(world, player, AERoom.W9L1Western.value, AERoom.W9L1Shaw.value, lambda state: HasSling(state, player) or HasHoop(state, player))
        connect_regions(world, player, AERoom.W9L1Western.value, AERoom.W9L1Flea.value, lambda state: HasSling(state, player) or HasHoop(state, player))
        connect_regions(world, player, AERoom.W9L1Crater.value, AERoom.W9L1Schafette.value, lambda state: MM_SHA(state, player) and HasFlyer(state, player))
        connect_regions(world, player, AERoom.W9L1Outside.value, AERoom.W9L1Donovan.value, lambda state: MM_UFODoor(state, player))
        connect_regions(world, player, AERoom.W9L1Outside.value, AERoom.W9L1Laura.value, lambda state: MM_UFODoor(state, player))
        connect_regions(world, player, AERoom.W9L1Castle.value, AERoom.W9L1Uribe.value, lambda state: MM_UFODoor(state, player) and HasPunch(state, player))
        connect_regions(world, player, AERoom.W9L1Castle.value, AERoom.W9L1Gordo.value, lambda state: MM_UFODoor(state, player) and (HasFlyer(state, player) or HasRC(state, player)))
        connect_regions(world, player, AERoom.W9L1Castle.value, AERoom.W9L1Raeski.value, lambda state: MM_UFODoor(state, player))
        connect_regions(world, player, AERoom.W9L1Castle.value, AERoom.W9L1Poopie.value, lambda state: MM_UFODoor(state, player))
        connect_regions(world, player, AERoom.W9L1Climb1.value, AERoom.W9L1Teacup.value, lambda state: MM_DoubleDoor(state, player))
        connect_regions(world, player, AERoom.W9L1Climb1.value, AERoom.W9L1Shine.value, lambda state: MM_DoubleDoor(state, player))
        connect_regions(world, player, AERoom.W9L1Climb2.value, AERoom.W9L1Wrench.value, lambda state: MM_SpaceMonkeys(state, player))
        connect_regions(world, player, AERoom.W9L1Climb2.value, AERoom.W9L1Bronson.value, lambda state: MM_SpaceMonkeys(state, player))
        connect_regions(world, player, AERoom.W9L1Head.value, AERoom.W9L1Bungee.value, lambda state: MM_DoubleDoor(state, player))
        ...
        connect_regions(world, player, AERoom.W9L1Side.value, AERoom.W9L1BG.value, lambda state: MM_SHA(state, player) and (HasSling(state, player) or HasFlyer(state, player)))
        ...
        if coins:
            ...
            connect_regions(world, player, AERoom.W8L1Outside.value, AERoom.Coin53.value,
                            lambda state: CP_FrontBarrels(state, player) and CanDive(state, player) and HasFlyer(state,
                                                                                                                 player))
...
def CC_WaterRoom(state, player):
    return CanHitMultiple(state, player) or (CanDive(state, player) and (HasSling(state, player) or HasFlyer(state, player) or HasPunch(state, player)))
...
def SF_MechRoom(state, player):
    return HasSling(state, player) or (HasHoop(state, player) and HasFlyer(state, player)) or (HasClub(state, player) and HasRC(state, player)) or HasPunch(state, player)
